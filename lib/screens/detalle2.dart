...
class DetalleForm2 extends StatefulWidget {
  _DetalleForm2State createState() => _DetalleForm2State();
}

class _DetalleForm2State extends State<DetalleForm2> {

  int _counter = 1;
  int _counterTotal = 50;
  int result;
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(children: [
                        ...
                        TextSpan(
                          text: result != null ? result.toString() + '.00' : '50.00',
                          style: TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.w600,
                            color: Colors.black,
